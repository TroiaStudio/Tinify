...
class CoverValidator implements ISizeValidator
{
	...
	{
		if ($test = ($width !== null && $height !== null)) {
			return true;
		}

		throw new ResizeMethodException('Cover: You must provide both a width and a height.');
	}
}
